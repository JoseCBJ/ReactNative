...
export default function HomeScreen() {
  ...
  const usuarios = [
    { id: "1", nome: "Jose", bio: "Desenvolvedor React Native" },
    { id: "2", nome: "Maria", bio: "Especialista em UX" },
    { id: "3", nome: "Carlos", bio: "Engenheiro de Software" },
  ];
    ...
    <View style={styles.container}>
      <FlatList
        ...
        renderItem={({ item }) => (
          ...
          >
            ...
            <Text style={styles.subtitulo}>{item.bio}</Text>
          </TouchableOpacity>
        )}
      />
      ...
      <Link href="/perfil" asChild>
        <TouchableOpacity style={styles.btReset}>
          <Text style={styles.textoBtCont}>Ver Perfil</Text>
        </TouchableOpacity>
      </Link>
    </View>
  );
